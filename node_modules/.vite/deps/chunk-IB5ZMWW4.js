...
var Pt = class _Pt {
  ...
  constructor(t2, e, n) {
    ...
    12.2 === _Pt.D(getUA()) && x2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
  ...
  static C() {
    ...
    if (_Pt.N())
      return true;
    const t2 = getUA(), e = _Pt.D(t2), n = 0 < e && e < 10, s = _Pt.k(t2), i = 0 < s && s < 4.5;
...
var Rr = class _Rr {
  ...
  Ge() {
    ...
    return n.set(this.directionalValue, 0), e !== t2 ? n.set([0], this.directionalValue.length) : ++n[n.length - 1], new _Rr(this.indexId, this.documentKey, this.arrayValue, n);
  }
};
function Pr(t2, e) {
...
var Fo = class _Fo {
  constructor(t2, e, n, s, i, r, o, u, c, a, h = 15) {
    ...
    this.ri = (t3) => Promise.resolve(), !_Fo.C())
...
var au = class _au {
  ...
  static er(t2, e, n) {
    ...
    return r && s.error && (r = "string" == typeof s.error.message && "string" == typeof s.error.code, r && (i = new L2(s.error.code, s.error.message))), r ? new _au(t2, e, s.state, i) : (x2("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), null);
  }
  nr() {
    const t2 = {
      state: this.state,
...
var hu = class _hu {
  ...
  static er(t2, e) {
    ...
    return i && n.error && (i = "string" == typeof n.error.message && "string" == typeof n.error.code, i && (s = new L2(n.error.code, n.error.message))), i ? new _hu(t2, n.state, s) : (x2("SharedClientState", `Failed to parse target state for ID '${t2}': ${e}`), null);
  }
  nr() {
    const t2 = {
      state: this.state,
...
var lu = class _lu {
  ...
  static er(t2, e) {
    ...
    return s ? new _lu(t2, i) : (x2("SharedClientState", `Failed to parse client data for instance '${t2}': ${e}`), null);
  }
};
var fu = class _fu {
  constructor(t2, e) {
  ...
  static er(t2) {
    ...
    return "object" == typeof e && -1 !== ["Unknown", "Online", "Offline"].indexOf(e.onlineState) && "string" == typeof e.clientId ? new _fu(e.clientId, e.onlineState) : (x2("SharedClientState", `Failed to parse online state: ${t2}`), null);
  }
};
var du = class {
  constructor() {
...
var $h = class _$h {
  ...
  oa(t2) {
    return new _$h(Object.assign(Object.assign({}, this.settings), t2), this.databaseId, this.Tt, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
  }
  ua(t2) {
    var e;
...
@firebase/firestore/dist/index.esm2017.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-IB5ZMWW4.js.map
